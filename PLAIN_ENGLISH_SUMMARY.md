...
- **`docs/`** — detailed writeups: `00_PROJECT_OVERVIEW.md` (story), `01_PIPELINE_DESIGN.md` (technical), `02_ROADMAP.md` (checklist), `03_MEETING_BRIEF.md` (one-pager), `04_OPEN_QUESTIONS.md` (questions), **`05_SERVER_SETUP.md` (the lab-server setup — Task 1)**.
