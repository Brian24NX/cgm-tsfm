...
> - The real data + the 3 targets live in Liuyi's **`diabetes-fitbit`** repo; its feature-engineering arm (Mack's) got **no predictive power**, which calibrates expectations.
